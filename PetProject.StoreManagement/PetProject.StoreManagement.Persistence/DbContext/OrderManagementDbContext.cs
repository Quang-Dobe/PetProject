...
{
    public class StoreManagementDbContext : DbContext, IUnitOfWork
    {
        private IDbContextTransaction _transaction;

        private readonly IDateTimeProvider _dateTimeProvider;

        public StoreManagementDbContext(DbContextOptions<StoreManagementDbContext> options, IDateTimeProvider dateTimeProvider) : base(options)
        {
