...
namespace PetProject.OrderManagement.Persistence.Repositories
{
    ...
    {
        public ProductRepository(OrderManagementDbContext dbContext, IDateTimeProvider dateTimeProvider, IExternalRepoService externalRepoService) : base(dbContext, dateTimeProvider, externalRepoService) { }
    }
}
