...
namespace PetProject.OrderManagement.Persistence.Repositories
{
    ...
    {
        public ClientRepository(OrderManagementDbContext dbContext, IDateTimeProvider dateTimeProvider, IExternalRepoService externalRepoService) : base(dbContext, dateTimeProvider, externalRepoService) { }
