...
namespace PetProject.OrderManagement.Persistence.Repositories
{
    ...
    {
        public UserRepository(OrderManagementDbContext dbContext, IDateTimeProvider dateTimeProvider, IExternalRepoService externalRepoService) : base(dbContext, dateTimeProvider, externalRepoService) { }
    }
}
